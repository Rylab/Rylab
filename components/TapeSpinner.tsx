...
import styles from './TapeSpinner.module.css'
...
export default function TapeSpinner({ children, spin = true, style, id }: TapeProps) {
  ...
  return (
    <div className={`${styles.cassetteContainer} cassette`} style={style} id={id} onClick={onCassetteClick}>
      <svg className={styles.background} width="697px" height="447px" viewBox="0 0 697 447" version="1.1">
